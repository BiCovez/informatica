...
llamaremos S(i)con los valores de la funcion y=seno(x) para x que varia en 10 grados
sexagesimales , y el otro arreglo A(i) conteniendo los valores de x. Mostrar los dos
arreglos en forma de tabla con una columna para el angulo y otra para la funcion.
